...
describe('user controller', () => {
  ...
  describe('getUser', () => {
    test('it returns an user with a 200 status code', async () => {
      let testUser = {
        id: "6501fd1d5a9366b89794b8f6", username: "test", roles: { User: 2001}, password: "test"
      }
      jest.spyOn(User, 'findOne')
        .mockResolvedValue(new User(testUser));
        
      const mockReq = { params: { id: "6501fd1d5a9366b89794b8f6" } }
  ...
  describe('deleteUser', () => {
    test('it returns a 200 status code on successful deletion', async () => {
      ...
      const mockReq = { body: {id: "6501fd1d5a9366b89794b8f6" } }
